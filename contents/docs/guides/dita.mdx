...
- Changes are commited into to the **dita** branch of the `μ/jjjjguevara` project in [GitHub](https://github.com/jjjjguevara/jjjjguevara.github.io)
- When a new version of the site's documentation is ready, the **dita** branch is merged into the `μ/jjjjguevara` **main** branch
