...
To us, this idea of **system** is nested in what is known as the *gnoseological space* - a space in which all of the components, primary elements, formal and material parts, etc. of positive sciences and related disciplines are organized. This space is comprised of 3 axes with 3 figures each:
...
> García Sierra, Pelayo. “Espacio Gnoseológico y Sus Figuras o Sectores | [190]” in *Diccionario Filosófico* July 05, 2021. [https://www.filosofia.org/filomat/df190.htm](https://www.filosofia.org/filomat/df190.htm).
